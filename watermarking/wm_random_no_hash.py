...
from .arg_classes.wm_arg_class import WmRandomNoHashArgs
...
def main(args: WmRandomNoHashArgs):
    ...
    lm_message_model.get_x_prefix_seeds = lambda x, transform: torch.ones(x.shape[0],
                                                                          device=x.device,
                                                                          dtype=torch.long)
